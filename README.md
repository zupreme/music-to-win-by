...
- Keep the GitHub Pages repo synced with the playable `audio/` bundle and the
  `audio/Zupreme-Music_to_Win_By.m3u` playlist so the 11 WAV masters stay portable.
...
1. GitHub Pages
   ...
   - `audio/` bundle with the WAV masters plus the playlist stored beside it
